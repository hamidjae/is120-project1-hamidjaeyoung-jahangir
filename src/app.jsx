...
{/* Checks what tab it's selecting, then applies the active class onto it */}
      ...
      <footer>
        <p><strong>Hamid Jaeyoung Jahangir</strong></p>
        <a className="fine-print" href="https://github.com/hamidjae/">GitHub</a>
        {' '}|{' '}
        <a className="fine-print" href="https://www.linkedin.com/in/hamid-jaeyoung/">LinkedIn</a>
      </footer>
    </BrowserRouter>
  );
}
